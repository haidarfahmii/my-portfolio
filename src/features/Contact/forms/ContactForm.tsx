...
export default function ContactForm({
  ...
  // kondisi tampilan berdasrkan variant "section" atau "modal"
  const labelColorClass =
    variant === "section" ? "text-gray-300" : "text-gray-700";
  const inputClasses =
    variant === "section"
      ? "w-full p-1 rounded-md bg-[#1c1c22] border border-gray-700 focus:outline-none focus:border-amber-400 transition-colors text-white"
      : "w-full rounded-md border border-gray-300 p-1 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-gray-900";
  const buttonClasses =
    variant === "section"
